    ...
    !(function () {
        ...
        function t() {
            if (!A && document.body) {
                ...
                if (
                    ...
                    r > n &&
                    (t.offsetHeight <= n || o.offsetHeight <= n)
                ) {
                    ...
                    if (
                        ((M = new W(T)), M.observe(t, l), B.offsetHeight <= n)
                    ) {
        ...
        function n(e, t, o) {
            if ((p(t, o), 1 != z.accelerationMax)) {
                ...
                if (r < z.accelerationDelta) {
                    var a = (1 + 50 / r) / 2;
                    a > 1 &&
                        ((a = Math.min(a, z.accelerationMax)),
                        (t *= a),
                        (o *= a));
                }
                j = Date.now();
        ...
        function a(e) {
            ...
            var i,
                ...
                f = s.clientHeight;
            switch (
                (s == document.body && (f = window.innerHeight), e.keyCode)
            ) {
                case K.up:
                    d = -z.arrowScroll;
                    break;
...
/*
     FILE ARCHIVED ON 13:23:49 Sep 19, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 17:54:40 May 01, 2024.
...
playback timings (ms):
  ...
  cdx.remote: 0.066
  esindex: 0.011
  LoadShardBlock: 124.723 (3)
  PetaboxLoader3.datanode: 137.929 (4)
  load_resource: 64.253
  PetaboxLoader3.resolve: 43.039
*/
